# Skate 0.1.2 — C1 checkpoint

Skate 0.1.2 is a work in progress for Z80 computers running CP/M. C1 adds a
small direct compiler command under `src/`. It reads one arithmetic expression
...
C1 reports malformed input, numeric overflow and source-I/O errors. It uses
