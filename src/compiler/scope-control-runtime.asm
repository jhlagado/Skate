...
SRTHEAP    EQU 06000H              ; Closure environments use the free TPA band.
SRTHEPEN  EQU 0C000H              ; Heap stops before the operator side stack.
...
SRTSTART:
        ...
        LD HL,SRTHEPEN            ; The operator side stack starts above the heap.
...
SRTOPS:       DW SRTHEPEN          ; Operator side-stack cursor between heap and guard.
