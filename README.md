...
Skate 0.5.1 supports exact signed integers, booleans, symbols, strings,
...
See the [release notes](release/v0.5.1/README.md) for examples, sizes and current limitations.
