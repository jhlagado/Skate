...
const lines = [
  ...
  `AROBLEN EQU ${object.length}`,
  `ARIMGOF EQU ${imageOffset}`,
  `ARIMGLN EQU ${payload.length}`,
  `ARCRCLN EQU ${crcOffset}`,
  `ARCRCOF EQU ${crcOffset}`,
  `ARROPOF EQU ${offset("ARROP")}`,
  `ARRLTOF EQU ${offset("ARRLT")}`,
  `ARRLVOF EQU ${offset("ARRLV")}`,
  `ARRRTOF EQU ${offset("ARRRT")}`,
  `ARRRVOF EQU ${offset("ARRRV")}`,
  `ARRSTOF EQU ${offset("ARRSTART")}`,
  "AROBJ:",
];
