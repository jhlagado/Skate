...
assert.ok(compiler.address("AROBJEND") < 0x8000);
...
try {
  ...
  // ARRLV is generated at payload offset 344; changing it proves runtime work.
  mutated[344] = 41;
  mutated[345] = 0;
  ...
  console.log(JSON.stringify(
    {
      ...
      compilerCode: compiler.address("AROBJ") - compiler.address("ARMAIN"),
      readerCode: compiler.address("REND") - compiler.address("RINIT"),
      compilerWorkspace: compiler.address("AROBJEND") -
        compiler.address("AROBJ"),
